...
?>
<div id="newtrip">
	<form id="form1" method="post" action="<?php echo "edit_trip.php?id=$id&belongs_to=$belongs_to"?>">
	    
        <table>
            <tr >
                <th colspan="2" class="head">修改旅程</th>
            </tr>
            <tr>
                <td class="left">旅程名稱</td>
                <td class="right"><input type="text" name="title" id="title" value="<?php echo $trip->name?>"/></td>
            </tr>
            <tr>
                <td class="left">類型</td>
            ...
            <tr>
                ...
                <td class="right"><input type="date" name="start_date" value="<?php echo $trip->time; ?>"/></td>
            </tr>
            <tr>
                <td class="left">時間</td>
            ...
            <tr class="foot">
                <td colspan="2"><input type="submit" name="submit" id="submit" value="修改" />                                                  
